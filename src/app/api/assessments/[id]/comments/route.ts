...
Rispondi in formato JSON con questa struttura:
{
  ...
  "global": "commento globale 3-4 righe"
    ...
    console.error("POST /api/assessments/[id]/comments error:", error);
    return NextResponse.json(
      { error: "Errore nella generazione dei commenti" },
      { status: 500 }
    );
  }
}
...
export async function GET(
  ...
  try {
    ...
    console.error("GET /api/assessments/[id]/comments error:", error);
    return NextResponse.json(
