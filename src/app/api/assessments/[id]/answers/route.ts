...
export async function GET(
  ...
  try {
    ...
    console.error("GET /api/assessments/[id]/answers error:", error);
...
export async function PUT(
  ...
  try {
    ...
    console.error("PUT /api/assessments/[id]/answers error:", error);
    return NextResponse.json(
      { error: "Errore nel salvataggio delle risposte" },
      { status: 500 }
    );
  }
}
